...
public class C4ACareReceiverListResponse {
    ...
    public C4ACareReceiverListResponse(long userId, int age, String frailtyStatus, String frailtyNotice, char attention, String textline, char interventionstatus, String interventionDate, String detectionStatus, String detectionDate) {
        this.userId = userId;
        this.age = age;
